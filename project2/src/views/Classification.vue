  ...
  <div>
    <div class="box">
      ...
      <div class="zhanshi">
        ...
        <div class="zhanshi_c">
          <div class="all">
            <div class="all_l">全部歌单</div>
            <div class="all_m">推荐</div>
            <div class="all_r">最新</div>
          </div>
        ...
        <div class="fenye">
          <ul>
            <li style="background-color: #31c27c">
