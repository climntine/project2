      ...
      <div class="main">
        <div class="SongInfo">
          ...
          <div class="SongInfo_r">
            <div class="SongName">七里香</div>
            <div class="singer">
              <i class="iconfont">&#xe602;&nbsp;</i>周杰伦
            </div>
            <div class="album">POP流行</div>
            <div class="language">语种:汉语</div>
            <div class="schools">流派:Rock</div>
            <div class="compony">唱片公司:杰威尔音乐有限公司</div>
            <div class="OpenTime">发行时间:2004-08-03</div>
            <div class="btn">
              <a href="">￥20 购买</a>
